    ...
    return (
        <Box pt={10} alignItems='center' justifyContent='center' display='flex' flexDirection='column' sx={{ width: '100%' }}>
            <Box>
                ...
                >
                    <Tab sx={{ pt: 3, pb: 3 }} label="Kiến trúc nghệ thuật cấp quốc gia" {...a11yProps(0)} />
                    <Tab sx={{ pt: 3, pb: 3 }} label="Kiến trúc nghệ thuật cấp tỉnh" {...a11yProps(1)} />
                    <Tab sx={{ pt: 3, pb: 3 }} label="Di tích lịch sử cấp tỉnh" {...a11yProps(2)} />
                    <Tab sx={{ pt: 3, pb: 3 }} label="Di tích lịch sử" {...a11yProps(3)} />
                </Tabs>
            </Box>
