...
const NationalArchitectureTab: FC = () => {
    const [showMore, setShowMore] = React.useState(false);
    const { dataSites } = useSites()
    const dataFilter = dataSites.sites.filter(item => item.category === 'di-tich-kien-truc-cap-quoc-gia')
...
export default NationalArchitectureTab
